import sys
from PyQt5.QtWidgets import QDialog, QApplication, QPushButton, QVBoxLayout, QLabel, QLineEdit, QToolBar, QMainWindow, QAction, QFileDialog, QGridLayout, QCheckBox, QHBoxLayout, QFormLayout, QTableView
...
class Window(QDialog,QMainWindow):
    def __init__(self, parent=None):
        ...
        self.checkbox = QCheckBox("Normalize Data")
